...
const Homepage = () => {
  return (
    ...
    >
      <div className="h-full flex flex-col justify-between lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        {/* IMAGE CONTAINER */}
        <div className="h-[30%] lg:h-full lg:w-1/2 relative">
          <Image src="/hero-transparent.png" alt="" fill className="object-contain" />
        </div>
        {/* TEXT CONTAINER */}
